              ...
              <Grid container spacing={3}>
                ...
                <Grid item xs={12}>
                  <TextField required id="address"
                             name="address" label="Address" fullWidth
                             autoCapitalize="given-name" multiline rows={4}/>
                </Grid>
                ...
                <Grid item xs={12} sm={6}>
                  <TextField required id="state"
                             name="state" label="State/Province/Region" fullWidth
                             autoCapitalize="given-name"/>
                </Grid>

                <Grid item xs={12} sm={6}>
                  <TextField required id="zip"
                             name="zip" label="Zip/Portal Code" fullWidth
                ...
                <Grid item xs={12} sm={6}>
                  <Button sx={{ py: 1.5, mt: 2, bgcolor: 'purple' }} size="large" variant="contained"
                          type="submit">
                    Deliver Here
                  </Button>
                </Grid>
