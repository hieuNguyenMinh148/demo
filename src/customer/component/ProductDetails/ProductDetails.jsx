    ...
    <div className="bg-white lg:px-20">
      <div className="pt-6">
        ...
        <section className="grid grid-cols-1 lg:grid-cols-2 gap-x-8 gap-y-10 px-4 pt-10">
          ...
          {/* Product info */}
          <div
            className="lg:col-span-1 maxt-auto max-w-2xl px-4 sm:px-6 lg:max-w-7xl lg:px-8 lg:pb-24">
            ...
            <div className="mt-4 lg:row-span-3 lg:mt-0">
              ...
              <div className="flex space-x-5 items-center text-lg lg:text-xl text-gray-900 mt-6">
                ...
                <p className="text-green-500 font-semibold ">{products.product?.discountPresent}% Off</p>
              </div>
              ...
              <div className="mt-6">
                <div className="flex items-center space-x-3">
                  ...
                  <p className="opacity-50 text-sm">50000 Ratings</p>
                  <p className="ml-3 text-sm font-semibold text-indigo-600 hover:text-indigo-500">2340
                    Reviews</p>
                </div>
              </div>
              ...
              <form className="mt-10">
                ...
                <Button onClick={handleAddToCart} variant="contained"
                        sx={{ px: '2rem', py: '1rem', mt: '1rem', bgcolor: 'purple' }}>
                  Add To Cart
                </Button>
              </form>
            </div>
          ...
          <div className="border p-5">
            <Grid container spcacing={7}>
              ...
              <Grid item xs={5}>
                ...
                <div className="flex items-center space-x-3">
                  <Rating name="read-only" value={3.7} precision={.5} readOnly/>
                  <p className="opacity-60">35401 Ratings</p>
                </div>
                ...
                <Box className="mt-5 space-y-3">
                  ...
                  <Grid container alignItems="center" gap={2}>
                    ...
                    <Grid item xs={7}>
                      <LinearProgress sx={{ bgcolor: '#d0d0d0', borderRadius: 4, height: 7 }}
                                      variant="determinate" value={25} color="primary"/>
                    </Grid>
                  </Grid>
